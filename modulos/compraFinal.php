	...
	try{
		...
		if ($num>=1) {
			...
			echo '
						...
						<a class="btn btn-primary" href="evento.php?idEvento='.$fila['idEvento'].'">Seguir Comprando</a>

						<a class="btn btn-success col-md-offset-0" data-toggle="modal" data-target="#myModal" id="consultaCelular">Continuar Proceso</a>
						<br><br>
				';
		}else{
